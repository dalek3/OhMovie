((global) => {
    ...
    _getApi = (count, genres, year) => {
        for (let i = 1; i <= page; i++) {
            fetch(`https://api.themoviedb.org/3/discover/movie?api_key=bfdc49ba22b11be34746dd5c861c3d27&language=ko-KR&sort_by=${sort.value}&include_adult=false&include_video=false&page=${i}&primary_release_year=${year.value}&with_genres=${genres.value}`)
