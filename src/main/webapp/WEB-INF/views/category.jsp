            ...
            <section>
                <div>
                    <h3 class="box-title">카테고리</h3>
                        연도
                        <select name="primary_release_year" id="year" >
                        ...
                        <select name="sort_by" id="sort_by" >
                            <option value="popularity.desc" selected="selected">인기도 내림차순</option>
                        ...
                        <p>총 <span id="count"></span>개의 작품이 검색되었어요</p>
                        <!-- <div class="dropdown">
                            <button class=" btn btn-outline btn-default dropdown-toggle" data-toggle="dropdown" href="#">정렬</button>
